...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashscreen: SplashScreen, public global: AppState) {
    ...
    this.pages = [
      ...
      { title: 'Search', component: SearchPage, active: true, icon: 'search' },
      { title: 'Overview', component: OverviewPage, active: false, icon: 'home' },
      { title: 'Customer Profile', component: IonicOfficialComponentsPage, active: false, icon: 'alarm' },
      { title: 'Assets', component: LoginListPage, active: false, icon: 'archive' },
      { title: 'Liabilities', component: ListsPage, active: false, icon: 'body' },
      { title: 'Credit Facility', component: PopupModalsPage, active: false, icon: 'basket' },
      { title: 'Pricing', component: MiscellaneousListPage, active: false, icon: 'bookmarks' },
      { title: 'Sign Out', component: HomePage, active: false, icon: 'power' },
    ];
